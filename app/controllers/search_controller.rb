class SearchController < ApplicationController
  ...
  def hospitals
    ...
    render :json => hospitals.map { |hospital| {:id => hospital.id.to_s, :code => hospital.hospital_id, :text => hospital.name}}
  end
  ...
  def codes
    ...
    render :json => codes.map { |code| {:id => code.id.to_s, :code => code.code, :text => code.text(@locale)}}
  end
