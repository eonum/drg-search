...
class Hospital < ActiveRecord::Base
  ...
  searchkick word_middle: [:name, :address], language: 'german', callbacks: false,
             ...
             ['fmi', 'frutigen meiringen interlaken'], ['sro',	'spital region oberaargau'], ['hôpital du jura bernois', 'st imier', 'hôpital du jura bernois sa', 'hôpital de st-imier', 'st-imier'],
